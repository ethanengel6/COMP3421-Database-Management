...
myc.execute("""
  load data local infile '/Users/elain/Desktop/COMP3421/data_sailors.txt' into table sailors
...
myc.execute("""
load data local infile '/Users/elain/Desktop/COMP3421/data_boats.txt' into table boats
  fields terminated by ','
  lines terminated by '\n' ;
""")

myc.execute("""
load data local infile '/Users/elain/Desktop/COMP3421/data_reserve.txt' into table reserve
  fields terminated by ','
  lines terminated by '\n' ;
""")
